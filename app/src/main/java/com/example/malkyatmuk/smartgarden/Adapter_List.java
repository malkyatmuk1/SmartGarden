...
public class Adapter_List extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                class LongOperation extends AsyncTask<String, Void, Void> {
                    ...
                    protected Void doInBackground(String... Param) {
                        ...
                        try {
                            ...
                            BufferedReader inFromServer = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
                            if (isChecked)
                                outToServer.writeBytes("setPermission " +name+ " u " + Global.username + " " + Global.password + '\n');
                            else
        ...
        if(spliter[1].equals("n")) holder.switchP.setText("non-user");
        else holder.switchP.setText("user");

        if(spliter[1].equals("u") || spliter[1].equals("a")){holder.switchP.setOnCheckedChangeListener(null);holder.switchP.setChecked(true);holder.switchP.setOnCheckedChangeListener(checkListener);}
